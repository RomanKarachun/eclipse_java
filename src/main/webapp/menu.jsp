...
<t:wrapper>
	...
	<div class="light-blue lighten-1"><h1 style="text-align: center;   color:white;">TAXI CONTROL ROOM</h1>		
		...
		<table>
			...
			<tbody>
				<tr>
					<th><a href="menu.jsp"><i class="large material-icons">home</i></a></th>
				     ...
				     <th class="active"><a onclick="sendHTTPDelete('/login')"><i class="large material-icons">exit_to_app</i></a></th>
				</tr>
			</tbody>
			<tbody>
				<tr>					
