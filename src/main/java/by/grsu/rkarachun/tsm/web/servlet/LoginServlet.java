...
import by.grsu.rkarachun.tsm.web.security.AuthenticationFilter;
import by.grsu.rkarachun.tsm.web.security.User;

public class LoginServlet extends HttpServlet {
	private static final List<User> USERS = new ArrayList<>();
	static {
		USERS.add(new User("client", "12345678", "Karachun"));
		USERS.add(new User("driver", "87654321", "Kunickiy"));
		USERS.add(new User("blockeduser", "88888888", "Aleshin").setBlocked(true)); // no permissions
																										// to view the
																										// site
	}
